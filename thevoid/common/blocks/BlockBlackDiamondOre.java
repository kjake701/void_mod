...
public class BlockBlackDiamondOre extends Block
{
    ...
    {
        return this.blockID == TheVoid.BlockBlackDiamondOre.blockID ? TheVoid.ItemBlackDiamond.itemID : this.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        ...
        if (this.idDropped(par5, par1World.rand, par7) != this.blockID)
        {
           int var8 = 0;
            ...
            if (this.blockID == TheVoid.BlockBlackDiamondOre.blockID)
            {
