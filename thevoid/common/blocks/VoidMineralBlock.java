...
public class VoidMineralBlock extends Block
{
	private static final String VM = "rs:SuspiciousBlock";
    private boolean glowing;

    public VoidMineralBlock(int id, int texture, boolean par3)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon((this.VM));
    }
    ...
    {
        if (this.blockID == TheVoid.voidMineralGlowingBlock.blockID)
        {
            par1World.setBlock(par2, par3, par4, TheVoid.voidMineralBlock.blockID);
        }
    }
