...
public class BlockRedStoneCrystal extends Block
{
	private static final String RSO = "rs:RedStoneCrystalOre";
    private boolean glowing;

    public BlockRedStoneCrystal(int id, int texture, boolean par3)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon((this.RSO));
    }
    ...
    private void glow(World par1World, int par2, int par3, int par4)
    {
        ...
        if (this.blockID == TheVoid.BlockRedStoneCrystal.blockID)
        {
            par1World.setBlock(par2, par3, par4, TheVoid.BlockRedStoneCrystalGlowing.blockID);
        }
    }
    /**
    ...
    {
        if (this.blockID == TheVoid.BlockRedStoneCrystalGlowing.blockID)
        {
            par1World.setBlock(par2, par3, par4, TheVoid.BlockRedStoneCrystal.blockID);
        }
    }
    ...
    {
        return TheVoid.ItemRedStoneCrystal.itemID;
    }
    ...
    {
        return new ItemStack(TheVoid.BlockRedStoneCrystal);
    }
}
