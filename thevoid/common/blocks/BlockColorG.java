...
public class BlockColorG extends BlockBreakable
{
	private static final String ColorGlass = "rs:RedColorGlass";
	
    public BlockColorG(int par1)
    {
        super(par1, "RedColorGlass", Material.ice, false);
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon((this.ColorGlass));
    }
