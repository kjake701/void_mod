...
public class SpoooookyGen extends WorldGenerator
{
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        par1World.setBlock(par3, ++par4, par5, TheVoid.blockSpoooookyLantern.blockID);
        par1World.setBlockMetadataWithNotify(par3, par4 - 1, par5, Block.stoneBrick.blockID, 1);
        return true;
    }
}