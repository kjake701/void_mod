...
@Mod(modid = "kjake701_TheVoid", name = "The Void", version = "0.1.7.5")
...
public class TheVoid
{
	...
	//Items
	public static Item ItemRedStoneStick = (new ItemRedStoneStick(634)).setUnlocalizedName("RedStoneStick");
	public static Item ItemRedStonePick = (new ItemRedStonePick(625, 12, 1, ToolMaterials.BlackDiamond, null)).setUnlocalizedName("RedStonePick");
	public static Item RedStonePickPart3 = (new RedStonePickPart3(636)).setUnlocalizedName("RedStonePickPart3");
	public static Item RedStonePickPart2 = (new RedStonePickPart2(638)).setUnlocalizedName("RedStonePickPart2");
	public static Item RedStonePickPart1 = (new RedStonePickPart1(635)).setUnlocalizedName("RedStonePickPart1");
	public static Item ItemRedStoneSword = (new ItemRedStoneSword(543, 7, ToolMaterials.BlackDiamond)).setUnlocalizedName("RS:RedStoneSword");
	public static Item ItemBlackDiamond = (new ItemBlackDiamond(565, 8).setUnlocalizedName("RS:BlackDiamond"));
	public static Item ItemRedStoneCrystal = (new ItemRedStoneCrystal(568, 10).setUnlocalizedName("RS:RedStoneCrystal"));
	public static Item SuspiciousMinerals = (new SuspiciousMinerals(789));
	public static Item voidPortalStaff = (new VoidPortalStaff(780));
	...
	public final static Block blockRLog = new BlockRLog(200).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("RS:DeadLog").setTextureName("RS:DeadLog");
	
	public final static Block redWoodLeaves = new RedWoodLeaves(174).setHardness(0.2F).setLightOpacity(1).setStepSound(Block.soundGrassFootstep).setUnlocalizedName("RS:BoneLeaves");
	...
	public final static Block BlockColorG = (new BlockColorG(432)).setHardness(2.0f).setResistance(5.0f).setStepSound(Block.soundGlassFootstep).setUnlocalizedName("RS:RedColorGlass");
	
	public final static Block BlockRedStoneCrystal = (new BlockRedStoneCrystal(573, 11, false)).setHardness(12.0F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("RS:RedStoneCrystalOre");
	
	public final static Block BlockRedStoneCrystalGlowing = (new BlockRedStoneCrystalGlowing(575, 11, true)).setLightValue(0.625F).setHardness(12.0F).setResistance(10.0F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("RS:RedStoneCrystalOre");
	
	public final static Block BlockBlackDiamondOre = (new BlockBlackDiamondOre(544, 9)).setHardness(15.0F).setResistance(12.5F).setStepSound(Block.soundStoneFootstep).setUnlocalizedName("RS:BlackDiamondOre");
			 
	public final static Block RedWoodPlanks = (new RedWoodPlanks(250, 2)).setHardness(2.0F).setResistance(5.0F).setStepSound(Block.soundWoodFootstep).setUnlocalizedName("RS:RedWoodPlanks");
			
	public final static Block BlockRedWoodSapling = (new BlockRedWoodSapling(467)).setUnlocalizedName("RS:RedWood Sapling");
	...
	{	
		//Print
		System.out.println("[The Void] Activating The Void Version 0.1.7.5");
		...
		GameRegistry.registerBlock(BlockRedWoodSapling);
	    ...
	    LanguageRegistry.addName(blockRLog, "DeadWood Log");
		LanguageRegistry.addName(redWoodLeaves, "Redwood Leaves");
		LanguageRegistry.addName(BlockRedWoodSapling, "Redwood Sapling");
