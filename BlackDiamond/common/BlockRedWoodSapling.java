...
public class BlockRedWoodSapling extends BlockFlower
{
    public static final String[] WOOD_TYPES = new String[] {"oak", "spruce", "birch", "jungle"};
    @SideOnly(Side.CLIENT)
    private Icon[] redwoodsapling;
    private static final String RedSap = "rs:RedWoodSapling";

    protected BlockRedWoodSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
    ...
    {
        par2 &= 3;
        return this.redwoodsapling[par2];
    }
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new WorldGenRedWood(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {
            object = new WorldGenRedWood(true);
    ...
    {
        this.redwoodsapling = new Icon[WOOD_TYPES.length];

        for (int i = 0; i < this.redwoodsapling.length; ++i)
        {
            this.redwoodsapling[i] = par1IconRegister.registerIcon(this.RedSap);
        }
    }
}
