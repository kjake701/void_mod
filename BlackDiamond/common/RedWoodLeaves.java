...
{
    public static final String[][] field_94396_b = new String[][] {{"RedWoodLeaves"}, {"RedWoodLeaves_opaque"}};
    ...
    protected RedWoodLeaves(int par1)
    {
    ...
    {
        return RandomStuff.RedWoodSapling.blockID;
    }
